...
class Game(Frame):
    ...
    def createArea(self):
        a1 = Area("Area 1", "Game1Room1.gif")
        a2 = Area("Area 2", "Game1Room2.gif")
        a3 = Area("Area 3", "Game1Room3.gif")
        a4 = Area("Area 4", "Game1Room4.gif")
        a5 = Area("Area 5", "Game1Room5.gif")
        a6 = Area("Area 6", "Game1Room6.gif")
        a7 = Area("Area 7", "Game1Room7.gif")
        a8 = Area("Area 8", "Game1Room8.gif")
        a9 = Area("Area 9", "Game1Room9.gif")
        a10 = Area("Area 10", "Game1Room10.gif")
        a11 = Area("Area 11", "Game1Room11.gif")
        a12 = Area("Area 12", "Game1Room12.gif")
        a13 = Area("Area 13", "Game1Room13.gif")
        a14 = Area("Area 14", "Game1Room14.gif")
        a15 = Area("Area 15", "Game1Room15.gif")
        a16 = Area("Area 16", "Game1Room16.gif")
        a17 = Area("Area 17", "Game1Room17.gif")
        a18 = Area("Area 18", "Game1Room18.gif")
        a19 = Area("Area 19", "Game1Room19.gif")
        a20 = Area("Area 20", "Game1Room20.gif")
    ...
    def setupGUI(self):
        ...
        Game.player_input.grid(row=2, column=0, columnspan=2, sticky=N+S+E+W)
        Game.player_input.focus()


        img = None
        Game.image = Button(self, bg="white", image=img, borderwidth=0, highlightthickness=0, activebackground="white")
        ...
        text_frame.grid(row=1, column=0, columnspan=2, sticky=N+S+E+W)
    ...
    def setAreaImage(self):
        ...
        Game.image.grid(row=0, column=0, sticky=N+S+E+W)
    ...
    def process(self, event):
        ...
        if(verb == "advance"):
            ...
            if(len(Game.currentArea.items) > 0):
                ...
                Game.currentArea.items.remove(Game.currentArea.items[0])
